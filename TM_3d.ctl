...
(define-param xdim 100.0)   			;define x dimension
(define-param ydim 100.0)				;define y dimension
(define-param zdim 120.0)				;define z dimension
(define-param NA 1.35)
(define-param eps_sub 1)
(define-param sigmax 0.1)
(define-param sigmay 0.7)
...
(define-param rs 2)				;define resolution
(define-param pml_thick 8)			;define pml thickness
(define-param w 18)
...
(set! geometry 
      (list
;                (make block (center 0 0 30.0) (size infinity infinity 60.0)
